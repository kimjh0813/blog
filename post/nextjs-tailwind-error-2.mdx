...
Create Next App을 실행했을 때의 **package.json devDependencies**는 다음과 같았습니다:
...
객체의 plugins**만이 normalized 에 추가됩니다.
...
**tailwind plugin**이 실행되었습니다.

<br />

<Title>📝 마무리</Title>

사실 Next.js의 버전이 업데이트 되며 **package.json devDependencies**가 수정되어, 내가 직접 postcss 버전을 8.0.0 ~ 8.0.1로 수정하지 않는 이상 이 문제가 발생하지 않게 되었습니다.
